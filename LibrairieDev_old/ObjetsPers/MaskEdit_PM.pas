...
procedure Register;
begin
  RegisterComponents('PBMA', [TMaskEdit_PM]);
end;

constructor TMaskEdit_PM.Create(Aowner: TComponent);
begin
...
destructor TMaskEdit_PM.Destroy;
begin
     inherited;
end;

procedure TMaskEdit_PM.CreateWnd;
begin
inherited createWnd;
//Text:='';
...
procedure TMaskEdit_PM.CMEnter(var Message: TCMEnter);
Begin
     inherited;
     Color1 := Color;
...
procedure TMaskEdit_PM.CMExit(var Message: TCMExit);
begin
     inherited;
     Color :=  Color1;
     if (parent is TPanel) then begin
...
procedure TMaskEdit_PM.CWPaint(var Message: TWMPaint);
Begin
     inherited;
     if focused then
      begin
