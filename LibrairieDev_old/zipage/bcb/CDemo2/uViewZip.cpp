...
void __fastcall TfViewZip::FileListBox1DblClick( TObject *Sender ) {
    ...
    Memo->Lines->Clear();
    ZipBuilder1->ZipFilename = Label1->Caption;
...
void __fastcall TfViewZip::btnOpdaterClick( TObject *Sender ) {
    ...
    ZipBuilder1->FSpecArgs->Add( TempDizPath );
	 ZipBuilder1->ZipFilename = Label1->Caption;
    ZipBuilder1->Add();
    ZipBuilder1->ZipFilename = AnsiString( "" );
...
//---------------------------------------------------------------------------
void __fastcall TfViewZip::ZipBuilder1Message( TObject *Sender, int ErrCode, AnsiString Message ) {
