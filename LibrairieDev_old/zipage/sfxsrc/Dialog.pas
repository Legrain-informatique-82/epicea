...
BEGIN
   ...
   CASE DlgMessage OF
      WM_COMMAND: CASE LOWORD(DlgWParam) OF
         ...
         WM_INITDIALOG : BEGIN
                     CenterDialog(DlgWin);
                     Msg := CurrentFile + '...already exists, overwrite ?';
...
//                     CenterDialog(DlgWin);  ## MST moved
                     ...
                     if not usecl then  //## no cmd-line, so hide the run... checkbox
                       ...
                       begin
                        ...
                        sendmessage(cm1,wm_settext,0,integer(pchar('run "'+
                        extractfilename(getarg(1))+' '+extractfilename(getarg(2)))+'" after extraction'));
         ...
         WM_COMMAND    : CASE LOWORD(DlgWParam) OF
                            ...
                            cm_browse:begin
                               ...
                               if DialogBox( hInstance, 'DLGSEL', dlgwin, @seldialogProc ) = idok then begin
