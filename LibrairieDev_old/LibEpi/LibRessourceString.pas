...
//C_Date='05/07/2011';     transferer dans dll lgrLib
//C_Version1='2.0.0.7';
...
C_COGERE = ' COGERE';
//titleSupp= 'Version n° '+C_version+'  du '+C_Date;
//////  **************************
...
VersionAnterieurRestauration = 'Votre version de restauration d''Epicéa ne vous permet pas de restaurer cette sauvegarde ';
...
RappelEpuration                = 'Attention, l''épuration est une opération définitive qui consiste à' + RetourChariotSimple +
                  ...
                  // Commun
EditionDossierDemo =RetourChariotSimple+'---------------------------------------------------------------------------'+ RetourChariotSimple+
                   'Edition non disponible sur le dossier Demo.'+ RetourChariotSimple +
                   '---------------------------------------------------------------------------';
...
MessageChangementCodeTva='Cette écran vous permet de changer un code tva '+
'par un autre, dans votre plan comptable et (ou) vos trames de saisie.'+retourchariotsimple+
'Ces changements sont irréversibles.';


MessageChangementTauxTva='Cette écran vous permet de changer un taux de tva '+
'par un autre, dans votre plan comptable et (ou) vos trames de saisie.'+retourchariotsimple+
'Ces changements sont irréversibles.';

MessageMiseAJourTrameSaisie='Cette écran vous permet de mettre à jour '+
'le code, le type et le taux de tva de vos trames de saisie à partir des paramètres tva des comptes de votre plan comptable.'+retourchariotdouble+
'Ces changements sont irréversibles.';

MessageAttentionMiseAJourTrame='Vous allez mettre à jour le code, le type et le taux de tva des lignes de vos trames'+
                       ' à partir des paramètres tva du plan comptable'+retourchariotdouble
