...
// Version  : 1.0
// (14/11/2016 15:59:46 - 1.33.2.5)
// ************************************************************************ //

unit TaAutorisationsService5;
...
type
  ...
  errorResponse        = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  mergeDTOResponse     = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  mergeDTOValidationContextResponse = class;    { "http://service.autorisations.autorisations.legrain.fr/" }
  persistDTOResponse   = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  persistDTOValidationContextResponse = class;   { "http://service.autorisations.autorisations.legrain.fr/" }
  persistResponse      = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  persistValidationContextResponse = class;     { "http://service.autorisations.autorisations.legrain.fr/" }
  removeDTOResponse    = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  removeResponse       = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  selectAll            = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  selectAllDTO         = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  selectCount          = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  validateDTOPropertyResponse = class;          { "http://service.autorisations.autorisations.legrain.fr/" }
  validateDTOPropertyValidationContextResponse = class;   { "http://service.autorisations.autorisations.legrain.fr/" }
  validateDTOResponse  = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  validateDTOValidationContextResponse = class;   { "http://service.autorisations.autorisations.legrain.fr/" }
  validateEntityPropertyResponse = class;       { "http://service.autorisations.autorisations.legrain.fr/" }
  validateEntityPropertyValidationContextResponse = class;   { "http://service.autorisations.autorisations.legrain.fr/" }
  validateEntityResponse = class;               { "http://service.autorisations.autorisations.legrain.fr/" }
  validateEntityValidationContextResponse = class;   { "http://service.autorisations.autorisations.legrain.fr/" }
  RemoveException      = class;                 { "http://service.autorisations.autorisations.legrain.fr/"[F] }
  CreateException      = class;                 { "http://service.autorisations.autorisations.legrain.fr/"[F] }
  EJBException         = class;                 { "http://service.autorisations.autorisations.legrain.fr/"[F] }
  FinderException      = class;                 { "http://service.autorisations.autorisations.legrain.fr/"[F] }
  findWithNamedQueryDTO = class;                { "http://service.autorisations.autorisations.legrain.fr/" }
  findWithJPQLQueryDTO = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  findByCodeDTO        = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  findByCode           = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  module               = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  listeModules         = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  findByDossierTypeProduitResponse = class;     { "http://service.autorisations.autorisations.legrain.fr/" }
  selectCountResponse  = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  findByIdDTO          = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  findById             = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  findByDossierTypeProduit = class;             { "http://service.autorisations.autorisations.legrain.fr/" }
  taTypeProduit        = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  taAutorisations      = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  entityToDTO          = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  findByCodeResponse   = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  findByIdResponse     = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  merge                = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  mergeResponse        = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  mergeValidationContext = class;               { "http://service.autorisations.autorisations.legrain.fr/" }
  mergeValidationContextResponse = class;       { "http://service.autorisations.autorisations.legrain.fr/" }
  persist              = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  persistValidationContext = class;             { "http://service.autorisations.autorisations.legrain.fr/" }
  remove               = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  validateEntity       = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  validateEntityProperty = class;               { "http://service.autorisations.autorisations.legrain.fr/" }
  validateEntityPropertyValidationContext = class;   { "http://service.autorisations.autorisations.legrain.fr/" }
  validateEntityValidationContext = class;      { "http://service.autorisations.autorisations.legrain.fr/" }
  modelObject          = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  taAutorisationsDTO   = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  entityToDTOResponse  = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  error                = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  findByCodeDTOResponse = class;                { "http://service.autorisations.autorisations.legrain.fr/" }
  findByIdDTOResponse  = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  mergeDTO             = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  mergeDTOValidationContext = class;            { "http://service.autorisations.autorisations.legrain.fr/" }
  persistDTO           = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  persistDTOValidationContext = class;          { "http://service.autorisations.autorisations.legrain.fr/" }
  removeDTO            = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  validateDTO          = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  validateDTOProperty  = class;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  validateDTOPropertyValidationContext = class;   { "http://service.autorisations.autorisations.legrain.fr/" }
  validateDTOValidationContext = class;         { "http://service.autorisations.autorisations.legrain.fr/" }
  selectAllResponse    = class;                 { "http://service.autorisations.autorisations.legrain.fr/"[A] }
  selectAllDTOResponse = class;                 { "http://service.autorisations.autorisations.legrain.fr/"[A] }
  listEntityToListDTOResponse = class;          { "http://service.autorisations.autorisations.legrain.fr/"[A] }
  findWithNamedQueryDTOResponse = class;        { "http://service.autorisations.autorisations.legrain.fr/"[A] }
  findWithJPQLQueryDTOResponse = class;         { "http://service.autorisations.autorisations.legrain.fr/"[A] }
  listEntityToListDTO  = class;                 { "http://service.autorisations.autorisations.legrain.fr/"[A] }



  // ************************************************************************ //
  // Espace de nommage : http://service.autorisations.autorisations.legrain.fr/
  ...
  private
    ...
    Fniveau: WideString;
    Flimite: WideString;
    Fdate_module: WideString;
  published
    property id: WideString read Fid write Fid stored AS_ATTRIBUTE;
    property nom: WideString read Fnom write Fnom stored AS_ATTRIBUTE;
    property niveau: WideString read Fniveau write Fniveau stored AS_ATTRIBUTE;
    property limite: WideString read Flimite write Flimite stored AS_ATTRIBUTE;
    property date_module: WideString read Fdate_module write Fdate_module stored AS_ATTRIBUTE;
  end;

  modules    = array of module;                 { "http://service.autorisations.autorisations.legrain.fr/" }
  ...
  private
    Fmodules: modules;
    Fnb_poste_client: WideString;
    Fnb_utilisateur: WideString;
    Facces_webservice: WideString;
  public
    destructor Destroy; override;
  published
    property modules: modules read Fmodules write Fmodules;
    property nb_poste_client: WideString read Fnb_poste_client write Fnb_poste_client;
    property nb_utilisateur: WideString read Fnb_utilisateur write Fnb_utilisateur;
    property acces_webservice: WideString read Facces_webservice write Facces_webservice;
  end;
  ...
  // Serializtn : [xoLiteralParam]
  // ************************************************************************ //
  findByDossierTypeProduitResponse = class(TRemotable)
  private
  ...
  // Serializtn : [xoLiteralParam]
  // ************************************************************************ //
  findByDossierTypeProduit = class(TRemotable)
  private
    Farg0: WideString;
    Farg1: Integer;
  public
  ...
  published
    ...
    property codeDossier: WideString read FcodeDossier write FcodeDossier;
  ...
  return     = array of taAutorisations;        { "http://service.autorisations.autorisations.legrain.fr/" }
  ...
  arg0       = array of taAutorisations;        { "http://service.autorisations.autorisations.legrain.fr/" }
  ...
  ['{938605A6-8444-A755-EBB8-A458A4C5CFBF}']
    ...
    function  findByDossierTypeProduit(const parameters: findByDossierTypeProduit): findByDossierTypeProduitResponse; stdcall;
...
constructor findByDossierTypeProduitResponse.Create;
begin
  inherited Create;
  FSerializationOptions := [xoLiteralParam];
end;

destructor findByDossierTypeProduitResponse.Destroy;
begin
...
constructor findByDossierTypeProduit.Create;
begin
  inherited Create;
  FSerializationOptions := [xoLiteralParam];
end;
...
initialization
  InvRegistry.RegisterInterface(TypeInfo(TaAutorisationsService), 'http://service.autorisations.autorisations.legrain.fr/', '');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(TaAutorisationsService), '');
  ...
  RemClassRegistry.RegisterXSClass(errorResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'errorResponse');
  RemClassRegistry.RegisterSerializeOptions(errorResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(mergeDTOResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'mergeDTOResponse');
  RemClassRegistry.RegisterSerializeOptions(mergeDTOResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(mergeDTOValidationContextResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'mergeDTOValidationContextResponse');
  RemClassRegistry.RegisterSerializeOptions(mergeDTOValidationContextResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(persistDTOResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'persistDTOResponse');
  RemClassRegistry.RegisterSerializeOptions(persistDTOResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(persistDTOValidationContextResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'persistDTOValidationContextResponse');
  RemClassRegistry.RegisterSerializeOptions(persistDTOValidationContextResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(persistResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'persistResponse');
  RemClassRegistry.RegisterSerializeOptions(persistResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(persistValidationContextResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'persistValidationContextResponse');
  RemClassRegistry.RegisterSerializeOptions(persistValidationContextResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(removeDTOResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'removeDTOResponse');
  RemClassRegistry.RegisterSerializeOptions(removeDTOResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(removeResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'removeResponse');
  RemClassRegistry.RegisterSerializeOptions(removeResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(selectAll, 'http://service.autorisations.autorisations.legrain.fr/', 'selectAll');
  RemClassRegistry.RegisterSerializeOptions(selectAll, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(selectAllDTO, 'http://service.autorisations.autorisations.legrain.fr/', 'selectAllDTO');
  RemClassRegistry.RegisterSerializeOptions(selectAllDTO, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(selectCount, 'http://service.autorisations.autorisations.legrain.fr/', 'selectCount');
  RemClassRegistry.RegisterSerializeOptions(selectCount, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateDTOPropertyResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'validateDTOPropertyResponse');
  RemClassRegistry.RegisterSerializeOptions(validateDTOPropertyResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateDTOPropertyValidationContextResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'validateDTOPropertyValidationContextResponse');
  RemClassRegistry.RegisterSerializeOptions(validateDTOPropertyValidationContextResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateDTOResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'validateDTOResponse');
  RemClassRegistry.RegisterSerializeOptions(validateDTOResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateDTOValidationContextResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'validateDTOValidationContextResponse');
  RemClassRegistry.RegisterSerializeOptions(validateDTOValidationContextResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateEntityPropertyResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'validateEntityPropertyResponse');
  RemClassRegistry.RegisterSerializeOptions(validateEntityPropertyResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateEntityPropertyValidationContextResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'validateEntityPropertyValidationContextResponse');
  RemClassRegistry.RegisterSerializeOptions(validateEntityPropertyValidationContextResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateEntityResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'validateEntityResponse');
  RemClassRegistry.RegisterSerializeOptions(validateEntityResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateEntityValidationContextResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'validateEntityValidationContextResponse');
  RemClassRegistry.RegisterSerializeOptions(validateEntityValidationContextResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(RemoveException, 'http://service.autorisations.autorisations.legrain.fr/', 'RemoveException');
  RemClassRegistry.RegisterXSClass(CreateException, 'http://service.autorisations.autorisations.legrain.fr/', 'CreateException');
  RemClassRegistry.RegisterXSClass(EJBException, 'http://service.autorisations.autorisations.legrain.fr/', 'EJBException');
  RemClassRegistry.RegisterXSClass(FinderException, 'http://service.autorisations.autorisations.legrain.fr/', 'FinderException');
  RemClassRegistry.RegisterXSClass(findWithNamedQueryDTO, 'http://service.autorisations.autorisations.legrain.fr/', 'findWithNamedQueryDTO');
  RemClassRegistry.RegisterSerializeOptions(findWithNamedQueryDTO, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(findWithJPQLQueryDTO, 'http://service.autorisations.autorisations.legrain.fr/', 'findWithJPQLQueryDTO');
  RemClassRegistry.RegisterSerializeOptions(findWithJPQLQueryDTO, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(findByCodeDTO, 'http://service.autorisations.autorisations.legrain.fr/', 'findByCodeDTO');
  RemClassRegistry.RegisterSerializeOptions(findByCodeDTO, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(findByCode, 'http://service.autorisations.autorisations.legrain.fr/', 'findByCode');
  RemClassRegistry.RegisterSerializeOptions(findByCode, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(module, 'http://service.autorisations.autorisations.legrain.fr/', 'module');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(module), 'date_module', 'date-module');
  RemClassRegistry.RegisterXSInfo(TypeInfo(modules), 'http://service.autorisations.autorisations.legrain.fr/', 'modules');
  RemClassRegistry.RegisterXSClass(listeModules, 'http://service.autorisations.autorisations.legrain.fr/', 'listeModules');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(listeModules), 'nb_poste_client', 'nb-poste-client');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(listeModules), 'nb_utilisateur', 'nb-utilisateur');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(listeModules), 'acces_webservice', 'acces-webservice');
  RemClassRegistry.RegisterXSClass(findByDossierTypeProduitResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'findByDossierTypeProduitResponse');
  RemClassRegistry.RegisterSerializeOptions(findByDossierTypeProduitResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(selectCountResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'selectCountResponse');
  RemClassRegistry.RegisterSerializeOptions(selectCountResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(findByIdDTO, 'http://service.autorisations.autorisations.legrain.fr/', 'findByIdDTO');
  RemClassRegistry.RegisterSerializeOptions(findByIdDTO, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(findById, 'http://service.autorisations.autorisations.legrain.fr/', 'findById');
  RemClassRegistry.RegisterSerializeOptions(findById, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(findByDossierTypeProduit, 'http://service.autorisations.autorisations.legrain.fr/', 'findByDossierTypeProduit');
  RemClassRegistry.RegisterSerializeOptions(findByDossierTypeProduit, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(taTypeProduit, 'http://service.autorisations.autorisations.legrain.fr/', 'taTypeProduit');
  RemClassRegistry.RegisterXSClass(taAutorisations, 'http://service.autorisations.autorisations.legrain.fr/', 'taAutorisations');
  RemClassRegistry.RegisterXSClass(entityToDTO, 'http://service.autorisations.autorisations.legrain.fr/', 'entityToDTO');
  RemClassRegistry.RegisterSerializeOptions(entityToDTO, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(findByCodeResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'findByCodeResponse');
  RemClassRegistry.RegisterSerializeOptions(findByCodeResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(findByIdResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'findByIdResponse');
  RemClassRegistry.RegisterSerializeOptions(findByIdResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(merge, 'http://service.autorisations.autorisations.legrain.fr/', 'merge');
  RemClassRegistry.RegisterSerializeOptions(merge, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(mergeResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'mergeResponse');
  RemClassRegistry.RegisterSerializeOptions(mergeResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(mergeValidationContext, 'http://service.autorisations.autorisations.legrain.fr/', 'mergeValidationContext');
  RemClassRegistry.RegisterSerializeOptions(mergeValidationContext, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(mergeValidationContextResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'mergeValidationContextResponse');
  RemClassRegistry.RegisterSerializeOptions(mergeValidationContextResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(persist, 'http://service.autorisations.autorisations.legrain.fr/', 'persist');
  RemClassRegistry.RegisterSerializeOptions(persist, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(persistValidationContext, 'http://service.autorisations.autorisations.legrain.fr/', 'persistValidationContext');
  RemClassRegistry.RegisterSerializeOptions(persistValidationContext, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(remove, 'http://service.autorisations.autorisations.legrain.fr/', 'remove');
  RemClassRegistry.RegisterSerializeOptions(remove, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateEntity, 'http://service.autorisations.autorisations.legrain.fr/', 'validateEntity');
  RemClassRegistry.RegisterSerializeOptions(validateEntity, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateEntityProperty, 'http://service.autorisations.autorisations.legrain.fr/', 'validateEntityProperty');
  RemClassRegistry.RegisterSerializeOptions(validateEntityProperty, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateEntityPropertyValidationContext, 'http://service.autorisations.autorisations.legrain.fr/', 'validateEntityPropertyValidationContext');
  RemClassRegistry.RegisterSerializeOptions(validateEntityPropertyValidationContext, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateEntityValidationContext, 'http://service.autorisations.autorisations.legrain.fr/', 'validateEntityValidationContext');
  RemClassRegistry.RegisterSerializeOptions(validateEntityValidationContext, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(modelObject, 'http://service.autorisations.autorisations.legrain.fr/', 'modelObject');
  RemClassRegistry.RegisterXSClass(taAutorisationsDTO, 'http://service.autorisations.autorisations.legrain.fr/', 'taAutorisationsDTO');
  RemClassRegistry.RegisterXSClass(entityToDTOResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'entityToDTOResponse');
  RemClassRegistry.RegisterSerializeOptions(entityToDTOResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(error, 'http://service.autorisations.autorisations.legrain.fr/', 'error');
  RemClassRegistry.RegisterSerializeOptions(error, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(findByCodeDTOResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'findByCodeDTOResponse');
  RemClassRegistry.RegisterSerializeOptions(findByCodeDTOResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(findByIdDTOResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'findByIdDTOResponse');
  RemClassRegistry.RegisterSerializeOptions(findByIdDTOResponse, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(mergeDTO, 'http://service.autorisations.autorisations.legrain.fr/', 'mergeDTO');
  RemClassRegistry.RegisterSerializeOptions(mergeDTO, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(mergeDTOValidationContext, 'http://service.autorisations.autorisations.legrain.fr/', 'mergeDTOValidationContext');
  RemClassRegistry.RegisterSerializeOptions(mergeDTOValidationContext, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(persistDTO, 'http://service.autorisations.autorisations.legrain.fr/', 'persistDTO');
  RemClassRegistry.RegisterSerializeOptions(persistDTO, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(persistDTOValidationContext, 'http://service.autorisations.autorisations.legrain.fr/', 'persistDTOValidationContext');
  RemClassRegistry.RegisterSerializeOptions(persistDTOValidationContext, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(removeDTO, 'http://service.autorisations.autorisations.legrain.fr/', 'removeDTO');
  RemClassRegistry.RegisterSerializeOptions(removeDTO, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateDTO, 'http://service.autorisations.autorisations.legrain.fr/', 'validateDTO');
  RemClassRegistry.RegisterSerializeOptions(validateDTO, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateDTOProperty, 'http://service.autorisations.autorisations.legrain.fr/', 'validateDTOProperty');
  RemClassRegistry.RegisterSerializeOptions(validateDTOProperty, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateDTOPropertyValidationContext, 'http://service.autorisations.autorisations.legrain.fr/', 'validateDTOPropertyValidationContext');
  RemClassRegistry.RegisterSerializeOptions(validateDTOPropertyValidationContext, [xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(validateDTOValidationContext, 'http://service.autorisations.autorisations.legrain.fr/', 'validateDTOValidationContext');
  RemClassRegistry.RegisterSerializeOptions(validateDTOValidationContext, [xoLiteralParam]);
  RemClassRegistry.RegisterXSInfo(TypeInfo(return), 'http://service.autorisations.autorisations.legrain.fr/', 'return');
  RemClassRegistry.RegisterXSClass(selectAllResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'selectAllResponse');
  RemClassRegistry.RegisterSerializeOptions(selectAllResponse, [xoInlineArrays,xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(selectAllDTOResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'selectAllDTOResponse');
  RemClassRegistry.RegisterSerializeOptions(selectAllDTOResponse, [xoInlineArrays,xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(listEntityToListDTOResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'listEntityToListDTOResponse');
  RemClassRegistry.RegisterSerializeOptions(listEntityToListDTOResponse, [xoInlineArrays,xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(findWithNamedQueryDTOResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'findWithNamedQueryDTOResponse');
  RemClassRegistry.RegisterSerializeOptions(findWithNamedQueryDTOResponse, [xoInlineArrays,xoLiteralParam]);
  RemClassRegistry.RegisterXSClass(findWithJPQLQueryDTOResponse, 'http://service.autorisations.autorisations.legrain.fr/', 'findWithJPQLQueryDTOResponse');
  RemClassRegistry.RegisterSerializeOptions(findWithJPQLQueryDTOResponse, [xoInlineArrays,xoLiteralParam]);
  RemClassRegistry.RegisterXSInfo(TypeInfo(arg0), 'http://service.autorisations.autorisations.legrain.fr/', 'arg0');
  RemClassRegistry.RegisterXSClass(listEntityToListDTO, 'http://service.autorisations.autorisations.legrain.fr/', 'listEntityToListDTO');
