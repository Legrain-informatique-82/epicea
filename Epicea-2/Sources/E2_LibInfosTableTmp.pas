...
Procedure Initialise_TInfos_QSQ223(var Infos_QSQ223:TInfos_QSQ223);
Procedure Remplit_TInfos_QSQ223(DataSet:TDataSet;var Infos_QSQ223:TInfos_QSQ223);
Function Infos_TInfos_QSQ223(DataSet:TDataSet;ChampRech:String;const ValeurRech:array of variant):TInfos_QSQ223;
Procedure Initialise_TInfos_QSQ224(var Infos_QSQ224:TInfos_QSQ224);
Procedure Remplit_TInfos_QSQ224(DataSet:TDataSet;var Infos_QSQ224:TInfos_QSQ224);
Function Infos_TInfos_QSQ224(DataSet:TDataSet;ChampRech:String;const ValeurRech:array of variant):TInfos_QSQ224;
...
Procedure Initialise_TInfos_QSQ223(var Infos_QSQ223:TInfos_QSQ223);
Begin
Infos_QSQ223.Immobilisation:='';
Infos_QSQ223.report:=0;
Infos_QSQ223.Valeur_a_Amortir:=0;
Infos_QSQ223.choix:=0;
Infos_QSQ223.Cumul:=0;
Infos_QSQ223.Valeur_nette:=0;
Infos_QSQ223.Type_Amt:='';
Infos_QSQ223.Date_mise_en_service:=0;
Infos_QSQ223.Achat_Dans_Annee:=false;
Infos_QSQ223.ID:=0;
Infos_QSQ223.Ecriture_Cession:=0;
Infos_QSQ223.Cession_dans_annee:=false;
Infos_QSQ223.rebut:=false;
Infos_QSQ223.Date_cession:=0;
Infos_QSQ223.Mt_Cession:=0;
Infos_QSQ223.Compte:='';
Infos_QSQ223.Terminee:=false;
Infos_QSQ223.EnCours:=false;
Infos_QSQ223.CodeTerminee:='';
Infos_QSQ223.CompteTerminee:='';
end;
Procedure Remplit_TInfos_QSQ223(DataSet:TDataSet;var Infos_QSQ223:TInfos_QSQ223);
Begin
Initialise_TInfos_QSQ223(Infos_QSQ223);
Infos_QSQ223.Immobilisation:=DataSet.FindField('Immobilisation').AsString;
Infos_QSQ223.report:=DataSet.FindField('report').AsCurrency;
Infos_QSQ223.Valeur_a_Amortir:=DataSet.FindField('Valeur_a_Amortir').AsCurrency;
Infos_QSQ223.choix:=DataSet.FindField('choix').AsCurrency;
Infos_QSQ223.Cumul:=DataSet.FindField('Cumul').AsCurrency;
Infos_QSQ223.Valeur_nette:=DataSet.FindField('Valeur_nette').AsCurrency;
Infos_QSQ223.Type_Amt:=DataSet.FindField('Type_Amt').AsString;
Infos_QSQ223.Date_mise_en_service:=DataSet.FindField('Date_mise_en_service').AsDateTime;
Infos_QSQ223.Achat_Dans_Annee:=DataSet.FindField('Achat_Dans_Annee').Asboolean;
Infos_QSQ223.ID:=DataSet.FindField('ID').AsInteger;
Infos_QSQ223.Ecriture_Cession:=DataSet.FindField('Ecriture_Cession').AsInteger;
Infos_QSQ223.Cession_dans_annee:=DataSet.FindField('Cession_dans_annee').Asboolean;
Infos_QSQ223.rebut:=DataSet.FindField('rebut').Asboolean;
Infos_QSQ223.Date_cession:=DataSet.FindField('Date_cession').AsDateTime;
Infos_QSQ223.Mt_Cession:=DataSet.FindField('Mt_Cession').AsCurrency;
Infos_QSQ223.Compte:=DataSet.FindField('Compte').AsString;
Infos_QSQ223.Terminee:=DataSet.FindField('Terminee').Asboolean;
Infos_QSQ223.EnCours:=DataSet.FindField('EnCours').Asboolean;
Infos_QSQ223.CodeTerminee:=DataSet.FindField('CodeTerminee').AsString;
Infos_QSQ223.CompteTerminee:=DataSet.FindField('CompteTerminee').AsString;
end;
Function Infos_TInfos_QSQ223(DataSet:TDataSet;ChampRech:String;const ValeurRech:array of variant):TInfos_QSQ223;
Begin
Initialise_TInfos_QSQ223(result);
result.ResultInfos:=GrLocate(DataSet,ChampRech,ValeurRech);
if result.ResultInfos then
Remplit_TInfos_QSQ223(DataSet,result);
end;
Procedure Initialise_TInfos_QSQ224(var Infos_QSQ224:TInfos_QSQ224);
Begin
Infos_QSQ224.Immobilisation:='';
Infos_QSQ224.report:=0;
Infos_QSQ224.Valeur_a_Amortir:=0;
Infos_QSQ224.choix:=0;
Infos_QSQ224.Cumul:=0;
Infos_QSQ224.Valeur_nette:=0;
Infos_QSQ224.Type_Amt:='';
Infos_QSQ224.Date_mise_en_service:=0;
Infos_QSQ224.Achat_Dans_Annee:=false;
Infos_QSQ224.ID:=0;
Infos_QSQ224.Ecriture_Cession:=0;
Infos_QSQ224.Cession_dans_annee:=false;
Infos_QSQ224.rebut:=false;
Infos_QSQ224.Date_cession:=0;
Infos_QSQ224.Mt_Cession:=0;
Infos_QSQ224.Compte:='';
Infos_QSQ224.Terminee:=false;
Infos_QSQ224.EnCours:=false;
Infos_QSQ224.CodeTerminee:='';
Infos_QSQ224.CompteTerminee:='';
end;
Procedure Remplit_TInfos_QSQ224(DataSet:TDataSet;var Infos_QSQ224:TInfos_QSQ224);
Begin
Initialise_TInfos_QSQ224(Infos_QSQ224);
Infos_QSQ224.Immobilisation:=DataSet.FindField('Immobilisation').AsString;
Infos_QSQ224.report:=DataSet.FindField('report').AsCurrency;
Infos_QSQ224.Valeur_a_Amortir:=DataSet.FindField('Valeur_a_Amortir').AsCurrency;
Infos_QSQ224.choix:=DataSet.FindField('choix').AsCurrency;
Infos_QSQ224.Cumul:=DataSet.FindField('Cumul').AsCurrency;
Infos_QSQ224.Valeur_nette:=DataSet.FindField('Valeur_nette').AsCurrency;
Infos_QSQ224.Type_Amt:=DataSet.FindField('Type_Amt').AsString;
Infos_QSQ224.Date_mise_en_service:=DataSet.FindField('Date_mise_en_service').AsDateTime;
Infos_QSQ224.Achat_Dans_Annee:=DataSet.FindField('Achat_Dans_Annee').Asboolean;
Infos_QSQ224.ID:=DataSet.FindField('ID').AsInteger;
Infos_QSQ224.Ecriture_Cession:=DataSet.FindField('Ecriture_Cession').AsInteger;
Infos_QSQ224.Cession_dans_annee:=DataSet.FindField('Cession_dans_annee').Asboolean;
Infos_QSQ224.rebut:=DataSet.FindField('rebut').Asboolean;
Infos_QSQ224.Date_cession:=DataSet.FindField('Date_cession').AsDateTime;
Infos_QSQ224.Mt_Cession:=DataSet.FindField('Mt_Cession').AsCurrency;
Infos_QSQ224.Compte:=DataSet.FindField('Compte').AsString;
Infos_QSQ224.Terminee:=DataSet.FindField('Terminee').Asboolean;
Infos_QSQ224.EnCours:=DataSet.FindField('EnCours').Asboolean;
Infos_QSQ224.CodeTerminee:=DataSet.FindField('CodeTerminee').AsString;
Infos_QSQ224.CompteTerminee:=DataSet.FindField('CompteTerminee').AsString;
end;
Function Infos_TInfos_QSQ224(DataSet:TDataSet;ChampRech:String;const ValeurRech:array of variant):TInfos_QSQ224;
Begin
Initialise_TInfos_QSQ224(result);
result.ResultInfos:=GrLocate(DataSet,ChampRech,ValeurRech);
if result.ResultInfos then
Remplit_TInfos_QSQ224(DataSet,result);
end;
Procedure Initialise_TInfosC_Tva(var InfosC_Tva:TInfosC_Tva);
Begin
InfosC_Tva.ID:=0;
