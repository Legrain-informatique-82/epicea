...
begin
  ...
  BDE_ReInitLocalShare; //enlevé le 29/06/2014 pour pouvoir ouvrir plusieurs instances d'épicéa
  Session.SaveConfigFile ;

//if  (LocalShareIsTrue ) then  showmessage('le paramètre "Local Share" est à True !!!');

  DecimalSeparator:='.';
  ThousandSeparator:=#32;
//
  Session.NetFiledir:=sDirEXE;
Session.PrivateDir:=GetTempDir; //enlevé le 29/06/2014 pour pouvoir ouvrir plusieurs instances d'épicéa
  ...
  Application.Title := 'Epicéa-2 - Logiciel de comptabilité -';
...
//else
// begin
//  showmessage('Epicéa est déjà en cours d''exécution !');
//
////  BringWindowToTop(
////  FindWindow(
// end;
