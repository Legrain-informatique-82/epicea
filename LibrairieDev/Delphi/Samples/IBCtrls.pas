...
resourcestring
  SInterbaseNotInstalled = 'InterBase doit être installé pour pouvoir utiliser ce composant';
  SFailedQueEvents = 'Echec de la consultation de isc_que_events';
  SFailedInterprete = 'Echec de la consultation de isc_interprete';
  SFailedFree = 'Echec de la consultation de isc_free';
  SFailedEventBlock = 'Echec de la consultation de isc_event_block';
  SFailedEventCounts = 'Echec de la consultation de isc_event_counts';
  SFailedCancelEvents = 'Echec de la consultation de isc_cancel_events';
