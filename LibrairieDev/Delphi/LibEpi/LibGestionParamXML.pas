...
DMXml.ModifieVarDos(E.NomDossier,CXML_ExtensionFEC,E.ExtensionFEC);
DMXml.ModifieVarDos(E.NomDossier,CXML_SeparateurFEC,E.SeparateurFEC);
DMXml.ModifieVarDos(E.NomDossier,CXML_DatePieceFEC,str_bool2str(E.DatePieceFEC));
...
E.ExtensionFEC  :=DMXml.RetourneValVarDos(NomDossier,CXML_ExtensionFEC);
if(E.ExtensionFEC='')then E.ExtensionFEC  := '.csv';
E.SeparateurFEC :=DMXml.RetourneValVarDos(NomDossier,CXML_SeparateurFEC);
if(E.SeparateurFEC='')then E.SeparateurFEC  := '|';
E.DatePieceFEC := StrToBool_Lgr(DMXml.RetourneValVarDos(NomDossier,CXML_DatePieceFEC),false);
