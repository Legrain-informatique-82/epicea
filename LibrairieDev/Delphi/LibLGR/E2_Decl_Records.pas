...
//,GrGrid;
 ...
 CXML_NomSauvegarde = 'TextNomSauvegarde';
  ...
  CXML_ExtensionFEC = 'ExtensionFEC';
  CXML_SeparateurFEC = 'SeparateurFEC';
  CXML_DatePieceFEC = 'DatePieceFEC';
...
TInfoResteDCSurEcriture = record
 ...
 TResultChoixParamFEC = Record
  Retour:Boolean;
  Extension:String;
  Separateur:String;
  DatePieceDansDateEcriture:Boolean;
 End;


  TResultAffichePageWeb = Record
  Retour:Boolean;
 End;
