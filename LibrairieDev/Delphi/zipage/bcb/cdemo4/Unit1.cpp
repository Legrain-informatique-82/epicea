...
//---------------------------------------------------------------------------
void __fastcall TForm1::FillGrid( void ) {
	...
	SortGrid1->SortByColumn( GSortCol, GSortOptions );
}

//---------------------------------------------------------------------------
void __fastcall TForm1::OpenButClick( TObject *Sender ) {
	// Remove everything from grid except col titles.
	SortGrid1->RowCount = 2;
	SortGrid1->Rows[1]->Clear();
	SortGrid1->ColWidths[0] = 306;
...
//---------------------------------------------------------------------------
void __fastcall TForm1::InstButClick( TObject *Sender ) {
...
//---------------------------------------------------------------------------
void __fastcall TForm1::SortGrid1ClickSort( TObject *Sender, long Col, long Row, TSortOptions &SortOptions ) {
...
//---------------------------------------------------------------------------
void __fastcall TForm1::SortGrid1DrawCell( TObject *Sender, long Col, long Row, TRect &Rect, TGridDrawState State ) {
	if ( !Row && Col == GSortCol )
		ImageList1->Draw( SortGrid1->Canvas, Rect.Right - 18, 0, (GSortOptions.SortDirection == sdAscending) ? 0 : 1 );
}
